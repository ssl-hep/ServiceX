...
### Added
- Ability to set the Rucio RSE Expression for queries
...
July 8, 2025
### Added
- Server capability report includes max length of transform title
...
### Added
- Specific retries on writes to S3 to handle the inevitable SlowDown errors

### Changed
- Updated the usability of the test harness
