...
def transform_single_file(file_path: str, output_path: Path, output_format: str):
    ...
    if os.path.exists("/generated/parton.yaml"):
        shutil.copyfile("/generated/parton.yaml", os.path.join(os.environ.get("CONFIG_LOC"),"parton.yaml"))
    if os.path.exists("/generated/particle.yaml"):
        shutil.copyfile("/generated/particle.yaml", os.path.join(os.environ.get("CONFIG_LOC"),"particle.yaml")) 
