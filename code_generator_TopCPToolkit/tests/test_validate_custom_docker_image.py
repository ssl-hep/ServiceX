...
from servicex.TopCP_code_generator.request_translator import validate_custom_docker_image
...
class TestValidateCustomDockerImage:
    ...
    def test_validate_with_matching_prefix(self, monkeypatch: MonkeyPatch):
        monkeypatch.setenv("TOPCP_ALLOWED_IMAGES", '["sslhep/servicex_science_image_topcp:"]')
    ...
    def test_validate_with_multiple_prefixes(self, monkeypatch: MonkeyPatch):
        ...
        monkeypatch.setenv("TOPCP_ALLOWED_IMAGES", '["sslhep/servicex_science_image_topcp:", "docker.io/ssl-hep/"]')
        assert (
