...
To set this up, complete the following steps __before deploying__ ServiceX:
...
- Go to <https://api.slack.com/apps> and click __Create New App__.
...
- Click the __Add New Webhook to Workspace__ button at the bottom, choose your signups channel, and click the __Allow__ button.
