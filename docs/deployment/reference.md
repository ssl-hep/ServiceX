...
| `transformer.cachePrefix` | Prefix string to stick in front of file paths. Useful for XCache | null |
| `transformer.preferredEndpoints` | a comma separated list of endpoints in order of preference. | null |
| `transformer.avoidedEndpoints` | a comma separated list of endpoints to avoid. | null |
