...
Since there may be multiple replcias of each file, the DID finder can let Rucio know servicex location (latitude and longitude) so that Rucio can deliver replicas sorted according to their closeness.
