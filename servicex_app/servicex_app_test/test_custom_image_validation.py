...
class TestImageTagExtraction(unittest.TestCase):
    ...
    def test_extract_image_tag_from_topcp_query(self):
        ...
        result = self.submit_request._extract_custom_image_tag(json.dumps(query), 'topcp')
    ...
    def test_extract_image_tag_non_topcp_returns_none(self):
        ...
        result = self.submit_request._extract_custom_image_tag(json.dumps(query), 'uproot')
        self.assertIsNone(result)
