from servicex_app.web.kibana_url_filter import add_request_id_filter
...
class TestAddRequestIdFilter:
    ...
    def test_preserves_base_url(self):
        result = add_request_id_filter(self.EXAMPLE_URL, "abc-123", log_level="INFO")
    ...
    def test_includes_log_level_in_query(self):
        result = add_request_id_filter(self.EXAMPLE_URL, "abc-123", log_level="DEBUG")
